      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid md:grid-cols-3 gap-10 mb-12">
          ...
          <div>
            ...
            <div className="space-y-2">
              {links.map(l => (
                <a key={l.href} href={l.href} className="block text-sm text-primary-foreground/60 hover:text-teal transition-colors">
                  {l.label}
                </a>
              ))}
            </div>
          ...
          <div>
            ...
            <a href="mailto:support@getfincile.com" className="block text-sm text-teal hover:underline mb-2">support@getfincile.com</a>
        ...
        <div className="border-t border-primary-foreground/10 pt-6">
          <p className="text-xs text-primary-foreground/40 text-center">
            © 2026 Fincile. Revenue Audit • Reconciliation • Intelligence. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
